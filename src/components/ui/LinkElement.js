...
export default function LinkElement({ href, children, primary, secondary, link, ...props }) {
  return (
    <Link
      href={href}
      className={classNames({
        "text-sm/6 font-semibold rounded transition duration-300 block hover:underline": true,
